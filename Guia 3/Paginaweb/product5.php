    ...
    <section class="product-details">
        <div class="image-slider">
            <div class="product-images">
                <img src="img/product5.jpg" class="active" alt="">
                <img src="img/product5_2.jpg" alt="">
                <img src="img/product5_3.jpg" alt="">
            </div>
        </div>

    <div class="details">
        <h2 class="product-brand">ASUS - 11.6" Chromebook - Intel Celeron - 4GB Memory - 32GB eMMC Flash Memory - Gray - Grey</h2>
