    ...
    <section class="product-details">
        <div class="image-slider">
            <div class="product-images">
                <img src="img/product7.jpg" class="active" alt="">
                <img src="img/product7_2.jpg" alt="">
                <img src="img/product7_3.jpg" alt="">
            </div>
        </div>

    <div class="details">
        <h2 class="product-brand">HP - 14" Laptop - Intel Celeron - 4GB Memory - 64GB eMMC - Snowflake White</h2>
                 ...
                 <ul class="item-specs-list">
                    <li class="list-item">
                        ...
                        <div class="item-value-container">
                            <span class="item-value">14 inches</span>
                        </div>
                    </li>
                    <li class="list-item">
                        <div class="item-title-container">
                    ...
                    <li class="list-item">
                        ...
                        <div class="item-value-container">
                            <span class="item-value">Intel Celeron N4120 </span>
                        </div>
                    </li>
                    <li class="list-item">
                        <div class="item-title-container">
                    ...
                    <li class="list-item">
                        ...
                        <div class="item-value-container">
                            <span class="item-value">64 gigabytes </span>
                        </div>
                    </li>
                    <li class="list-item">
                        <div class="item-title-container">
                    ...
                    <li class="list-item">
                        ...
                        <div class="item-value-container">
                            <span class="item-value">Intel UHD Graphics 600 </span>
                        </div>
                    </li>
                    <li class="list-item">
                        <div class="item-title-container">
                        ...
                        <div class="item-value-container">
                            <span class="item-value">Windows 11 Home in S Mode </span>
                        </div>
                    </li>
                    <li class="list-item">
                        <div class="item-title-container">
                        ...
                        <div class="item-value-container">
                            <span class="item-value">Lithium-ion polymer </span>
                        </div>
                    </li>
                 </ul>
                </div>
