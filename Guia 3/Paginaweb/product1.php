    ...
    <section class="product-details">
        <div class="image-slider">
            <div class="product-images">
                <img src="img/product1.jpeg" class="active" alt="">
                <img src="img/product1_2.jpg" alt="">
                <img src="img/product1_3.jpg" alt="">
            </div>
        </div>

    <div class="details">
        <h2 class="product-brand">ASUS - 14.0" Chromebook - Intel Celeron N3350 - 4GB Memory - 32GB eMMC - Grey</h2>
        <div class="details-price">
            <span class="product-discount">( 50% off )</span> 
            <span class="product-price">$20</span>
            <span class="product-actual-price">$40</span>   
        </div>    
                ...
                <div class="item-specs">
                 <ul class="item-specs-list">
                    ...
                    <li class="list-item">
                        ...
                        <div class="item-value-container">
                            <span class="item-value">N3350 </span>
                        </div>
                    </li>
                    <li class="list-item">
                        <div class="item-title-container">
                    ...
                    <li class="list-item">
                        ...
                        <div class="item-value-container">
                            <span class="item-value">32 gigabytes </span>
                        </div>
                    </li>
                    <li class="list-item">
                        <div class="item-title-container">
                    ...
                    <li class="list-item">
                        ...
                        <div class="item-value-container">
                            <span class="item-value">Other </span>
                        </div>
                    </li>
                    <li class="list-item">
                        <div class="item-title-container">
