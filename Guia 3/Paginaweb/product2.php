    ...
    <section class="product-details">
        <div class="image-slider">
            <div class="product-images">
                <img src="img/product2.jpeg" class="active" alt="">
                <img src="img/product2_2.jpg" alt="">
                <img src="img/product2_3.jpg" alt="">
            </div>
        </div>

    <div class="details">
        <h2 class="product-brand">Dell - Inspiron Compact Desktop - Intel Core i5-12400 - 12GB Memory - 256GB SSD - Mist Blue</h2>
        <div class="details-price">
            <span class="product-discount">( 50% off )</span> 
            <span class="product-price">$50</span>
            <span class="product-actual-price">$100</span>   
        </div>    
                 ...
                 <ul class="item-specs-list">
                    <li class="list-item">
                        ...
                        <div class="item-value-container">
                            <span class="item-value">Intel 12th Generation Core i5 </span>
                        </div>
                    </li>
                    <li class="list-item">
                        <div class="item-title-container">
                        ...
                        <div class="item-value-container">
                            <span class="item-value">12400 </span>
                        </div>
                    </li>
                    <li class="list-item">
                        <div class="item-title-container">
                        ...
                        <div class="item-value-container">
                            <span class="item-value">6-core </span>
                        </div>
                    </li>
                    <li class="list-item">
                        <div class="item-title-container">
                        ...
                        <div class="item-value-container">
                            <span class="item-value">2.5 gigahertz </span>
                        </div>
                    </li>
                    <li class="list-item">
                        <div class="item-title-container">
                    ...
                    <li class="list-item">
                        ...
                        <div class="item-value-container">
                            <span class="item-value">12 gigabytes </span>
                        </div>
                    </li>
                    <li class="list-item">
                        <div class="item-title-container">
                    ...
                    <li class="list-item">
                        ...
                        <div class="item-value-container">
                            <span class="item-value">DDR4 </span>
                        </div>
                    </li>
                    <li class="list-item">
                        <div class="item-title-container">
                        ...
                        <div class="item-value-container">
                            <span class="item-value">3200 megahertz </span>
                        </div>
                    </li>
                    <li class="list-item">
                        <div class="item-title-container">
