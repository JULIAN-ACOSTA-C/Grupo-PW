    ...
    <section class="product-details">
        <div class="image-slider">
            <div class="product-images">
                <img src="img/product8.jpg" class="active" alt="">
                <img src="img/product8_2.jpg" alt="">
                <img src="img/product8_3.jpg" alt="">
            </div>
        </div>

    <div class="details">
        <h2 class="product-brand">HP - Pavilion Desktop - Intel Core i3 - 8GB Memory - 256GB SSD - Natural Silver</h2>
        <div class="details-price">
            <span class="product-price">$50</span>
            <span class="product-actual-price">$110</span>   
        </div>    
                 ...
                 <ul class="item-specs-list">
                    <li class="list-item">
                        ...
                        <div class="item-value-container">
                            <span class="item-value">Intel 10th Generation Core i3 </span>
                        </div>
                    </li>
                    <li class="list-item">
                        <div class="item-title-container">
                        ...
                        <div class="item-value-container">
                            <span class="item-value">Intel® Core™ i3-10100 </span>
                        </div>
                    </li>
                    <li class="list-item">
                        <div class="item-title-container">
                        ...
                        <div class="item-value-container">
                            <span class="item-value">4-core </span>
                        </div>
                    </li>
                    <li class="list-item">
                        <div class="item-title-container">
                    ...
                    <li class="list-item">
                        ...
                        <div class="item-value-container">
                            <span class="item-value">SSD </span>
                        </div>
                    </li>
                    <li class="list-item">
                        <div class="item-title-container">
                        ...
                        <div class="item-value-container">
                            <span class="item-value">256 gigabytes </span>
                        </div>
                    </li>
                    <li class="list-item">
                        <div class="item-title-container">
                    ...
                    <li class="list-item">
                        ...
                        <div class="item-value-container">
                            <span class="item-value">Windows 10 Home </span>
                        </div>
                    </li>
                    <li class="list-item">
                        <div class="item-title-container">
                        ...
                        <div class="item-value-container">
                            <span class="item-value">DDR4 SDRAM </span>
                        </div>
                    </li>
                    <li class="list-item">
                        <div class="item-title-container">
                            <span class="item-title">System Memory RAM Speed </span>
                        </div>
                        <div class="item-value-container">
                            <span class="item-value">2666 megahertz </span>
                        </div>
                    </li>
                    <li class="list-item">
                        <div class="item-title-container">
                        ...
                        <div class="item-value-container">
                            <span class="item-value">6 megabytes </span>
                        </div>
                    </li>
                    <li class="list-item">
                        <div class="item-title-container">
                    ...
                    <li class="list-item">
                        ...
                        <div class="item-value-container">
                            <span class="item-value">Intel UHD Graphics 630 </span>
                        </div>
                    </li>
                    <li class="list-item">
                        <div class="item-title-container">
                        ...
                        <div class="item-value-container">
                            <span class="item-value">Wi-Fi, Ethernet </span>
                        </div>
                    </li>
                    <li class="list-item">
                        <div class="item-title-container">
